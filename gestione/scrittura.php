...
<html lang="it">
  ...
  <body class="bg-dark text-light z-0">
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" name="contenuto" id="exampleFormControlTextarea1" rows="3"></textarea>
    </div>
    <div class="mb-3">
        <label for="formFile" name="copertina" class="form-label">Copertina</label>
        <input class="form-control" type="file" id="formFile">
    </div>
    <button type="submit" name="pubblica" class="btn btn-primary btn-lg">+ Pubblica Articolo</button>
    </form>
