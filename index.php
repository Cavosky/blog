...
<html lang="it">
    ...
    <body class="bg-dark text-light">
        <!--navbar-->
        <nav class="navbar bg-dark navbar-warning border border-warning-subtle position-sticky z-1 top-0 end-0 w-100">
            <div class="container-fluid">     
                ...
                <div class="text-end">
                    <button type="button" class="btn btn-outline-light me-2 mb-1 ">Login</button>
